...
-- the best refactor tool known to man
...
-- tabs
vim.keymap.set("n", "<leader>gt", ":tabnew<CR>", { silent = true })
vim.keymap.set("n", "<leader>gp", ":tabnext<CR>", { silent = true })
vim.keymap.set("n", "<leader>gx", ":tabclose<CR>", { silent = true })
